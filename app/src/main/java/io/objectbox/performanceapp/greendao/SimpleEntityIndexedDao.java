...
/** 
 * DAO for table "SIMPLE_ENTITY_INDEXED".
*/
public class SimpleEntityIndexedDao extends AbstractDao<SimpleEntityIndexed, Long> {

    public static final String TABLENAME = "SIMPLE_ENTITY_INDEXED";

    /**
     * Properties of entity SimpleEntityIndexed.<br/>
    ...
    public SimpleEntityIndexedDao(DaoConfig config) {
        super(config);
    }
    
    public SimpleEntityIndexedDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SIMPLE_ENTITY_INDEXED\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SIMPLE_ENTITY_INDEXED\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SimpleEntityIndexed entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SimpleEntityIndexed entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
        stmt.bindLong(2, entity.getSimpleBoolean() ? 1L: 0L);
        stmt.bindLong(3, entity.getSimpleByte());
    ...
    @Override
    public SimpleEntityIndexed readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, SimpleEntityIndexed entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SimpleEntityIndexed entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SimpleEntityIndexed entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SimpleEntityIndexed entity) {
