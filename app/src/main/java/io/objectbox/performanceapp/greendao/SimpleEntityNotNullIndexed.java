 ...
 */
@Entity
public class SimpleEntityNotNullIndexed {
    ...
    @Generated
    public SimpleEntityNotNullIndexed() {
    }

    public SimpleEntityNotNullIndexed(long id) {
        this.id = id;
    }

    @Generated
    public SimpleEntityNotNullIndexed(long id, boolean simpleBoolean, byte simpleByte, short simpleShort, int simpleInt, long simpleLong, float simpleFloat, double simpleDouble, String simpleString, byte[] simpleByteArray) {
        this.id = id;
